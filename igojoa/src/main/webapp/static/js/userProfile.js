...
function displayActivityInfo(data) {
    ...
    const $userFavoritePlacesList =
        document.querySelector("#favoritePlaceList");
    const $userFavoriteReviewsList = document.querySelector("#likedReviewList");
    const $userWrittenReviewsList =
        document.querySelector("#writtenReviewList");
    const $userVerifiedPlacesList =
        document.querySelector("#verifiedPlaceList");
    ...
    displayFavoritePlaces(
        ...
        $userFavoritePlacesList
    );

    // 좋아요한 리뷰
    displayLikedReviews(
        data.userFavoriteReviews || [],
        $userFavoriteReviewsList
    );

    // 작성한 리뷰
    displayWrittenReviews(
        data.userWrittenReviews || [],
        $userWrittenReviewsList
    );

    // 인증한 장소
    displayVerifiedPlaces(
        data.userVerifiedPlaces || [],
        $userVerifiedPlacesList
    );
}
