...
// 마이페이지 버튼을 눌렀을 때 서버에서 오는 응답을 처리하는 부분
// function loadUserProfile() {
//     axios
//         .post("/user/userProfile", {})
//         .then((response) => {
//             const userInfo = response.data;
//             // 사용자 정보를 페이지에 업데이트하는 코드
//             document.querySelector("#userId").textContent = userInfo.userId;
//             document.querySelector("#email").textContent = userInfo.email;
//             document.querySelector("#phoneNumber").textContent =
//                 userInfo.phoneNumber;
//             document.querySelector("currentsPoints").textContent =
//                 userInfo.currentPoints;
//             document.querySelector("cumulativePoint").textContent =
//                 userInfo.cumulativePoint;

//             // 프로필 이미지 업데이트
//             const $profileImage = document.querySelector("#userProfileUrl");
//             profileImage.src = userInfo.userProfileUrl;
...
function updateUserProfileUI(userInfo) {
    document.querySelector("#userId").textContent = userInfo.userId;
    document.querySelector("#email").textContent = userInfo.email;
    document.querySelector("#phoneNumber").textContent = userInfo.phoneNumber;
    document.querySelector("#currentPoints").textContent =
        userInfo.currentPoints;
    document.querySelector("#cumulativePoint").textContent =
        userInfo.cumulativePoint;
