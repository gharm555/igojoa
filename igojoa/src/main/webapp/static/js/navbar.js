document.addEventListener("DOMContentLoaded", function() {
    ...
    function setupEventListeners() {
        ...
        const $placeReportBtn = document.querySelector("#placeReportBtn");
        if ($placeReportBtn) {
            $placeReportBtn.addEventListener("click", showPlaceReportModal);
        }
    ...
    // 명소 제보하기 모달 띄우기
    function showPlaceReportModal() {
        console.log(4444444444444444);
        const placeReportModal = new bootstrap.Modal(document.getElementById("placeReportModal"));
        placeReportModal.show();
    }
});
