              ...
              <div class="card-body">
                <div
                  ...
                  <h2 class="card-title mb-5">
                    ${ pd.placeName } <span id="iscoreBedge"
                      ...
                      style="font-size: 13px;">${ pd.avgIScore }
                    </span>
                  </h2>
                ...
                <p class="card-text mb-3">
                  <i class="fas fa-info-circle me-2"
                    style="color: #4a6fa5"></i> ${ fn:replace(pd.placeDescription, '. ', '.<br>') }
                </p>
              </div>
            </div>
          </section>
      ...
      <h2 class="mb-4 d-flex justify-content-between align-items-center">
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="sortDropdownButton">
            ...
            <li>
              <button class="btn dropdown-item1"
                data-sort="modifiedAtASC">오래된순</button>
            </li>
            <li>
