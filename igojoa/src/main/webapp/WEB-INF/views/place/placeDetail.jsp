              ...
              <div class="card-body">
                <div
                  ...
                  <h2 class="card-title mb-5">
                    ${ pd.placeName } <span id="iscoreBedge"
                      ...
                      style="font-size: 11px">${ pd.avgIScore } </span>
                  </h2>
                  <i id="favoriteHeart" class="bi-heart"
                    style="color: red;"
                ...
                <p class="card-text mb-3">
                  <i class="fas fa-map-marker-alt me-2"
                    style="color: #4a6fa5"></i> ${ pd.address }
                </p>
                <p class="card-text mb-3">
                ...
                <p class="card-text mb-3">
                  <i class="fas fa-info-circle me-2"
                    style="color: #4a6fa5"></i> ${ pd.placeDescription }
                </p>
              </div>
            </div>
          </section>
            ...
            <form id="reviewForm">
              <div class="btn-group mb-3" role="group"
                ...
                <input type="checkbox" class="btn-check" id="btncheck1"
                  name="features" value="주차가능" autocomplete="off" /> <label
                  class="btn btn-outline-primary" for="btncheck1"
                  data-parkingAvailable="${pd.parkingAvailable}">주차가능</label>
                <input type="checkbox" class="btn-check" id="btncheck2"
                  name="features" value="경치좋은" autocomplete="off" /> <label
                  class="btn btn-outline-primary" for="btncheck2"
                  data-view="${ pd.view }">경치좋은</label> <input
                  type="checkbox" class="btn-check" id="btncheck3"
                  name="features" value="무료입장" autocomplete="off" /> <label
                  class="btn btn-outline-primary" for="btncheck3"
                  data-freeEntry="${pd.freeEntry}">무료입장</label> <input
                  type="checkbox" class="btn-check" id="btncheck4"
                  name="features" value="야경" autocomplete="off" /> <label
                  class="btn btn-outline-primary" for="btncheck4"
                  data-nightView="${pd.nightView}">야경</label> <input
                  type="checkbox" class="btn-check" id="btncheck5"
                  name="features" value="교통원활" autocomplete="off" /> <label
                  class="btn btn-outline-primary" for="btncheck5"
                  data-easyTransport="${pd.easyTransport}">교통원활</label>
              </div>
              <div class="btn-group mb-3" role="group"
                aria-label="Basic radio toggle button group">
                <input type="radio" class="btn-check" name="difficulty"
                  id="btnradio1" value="상" autocomplete="off" /> <label
                  class="btn btn-outline-primary" for="btnradio1">상</label>
                <input type="radio" class="btn-check" name="difficulty"
                  id="btnradio2" value="중" autocomplete="off" /> <label
                  class="btn btn-outline-primary" for="btnradio2">중</label>
                <input type="radio" class="btn-check" name="difficulty"
                  id="btnradio3" value="하" autocomplete="off" /> <label
                  class="btn btn-outline-primary" for="btnradio3">하</label>
              </div>
              <textarea class="form-control mb-3" id="reviewText"
                rows="4" placeholder="리뷰를 작성해주세요">${ pd.review }</textarea>
              <c:choose>
                <c:when test="${empty pd.review}">
                  <button id="createReviewBtn" type="submit"
      ...
      <h2 class="mb-4 d-flex justify-content-between align-items-center">
        ...
        <div class="dropdown">
          <button class="btn btn-secondary dropdown-toggle"
            type="button" id="sortDropdownButton"
