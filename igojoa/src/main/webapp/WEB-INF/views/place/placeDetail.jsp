              ...
              <form id="reviewForm">
                ...
                >
                  ...
                  <label
                    ...
                    for="btncheck1"
                    data-parkingAvailable="${pd.parkingAvailable}"
                    >주차가능</label
                  >
                  <input
                    type="checkbox"
                  ...
                  <label
                    class="btn btn-outline-primary"
                    for="btncheck5"
                    data-easyTransport="${pd.easyTransport}"
                    >교통원활</label
                  >
                </div>
        ...
        <h2 class="mb-4 d-flex justify-content-between align-items-center">
          ...
          <div class="dropdown">
            ...
            >
              <li>
                <button
                  class="btn dropdown-item1 active"
                  data-sort="modifiedAtDESC"
                >
                  최신순
                </button>
              </li>
