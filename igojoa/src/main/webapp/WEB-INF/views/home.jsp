            ...
            <section>
                <div class="container-fluid main-container" id="container">
                    <div class="row text-center">
                        ...
                        >
                            ...
                            >
                                <div class="main-card">
                                    <div
                                        class="main-card-header bg-transparent"
                                    >
                                        <div
                                        ...
                                        >
                                            ...
                                            <i
                                                class="bi bi-heart main-custom-heart"
                                            ></i>
                                        </div>
                                        <div class="main-badges mt-3">
                                            <span class="badge"
                                                >${place.highestBadge}</span
                                            >
                                            <span class="badge"
                                                >${place.secondHighestBadge}</span
                                            >
                                            <span
                                                class="badge difficulty ${place.IScore}"
                                                >난이도: ${place.IScore}</span
                                            >
                                        </div>
                                    </div>
                                    <div
                                        class="d-flex justify-content-between my-3 mx-3"
                                    >
                                        <h3>${place.address}</h3>
                                        <h4>
                                            누적방문수: ${place.placeVerified}
                                        </h4>
                                    </div>
                                    ...
                                    <div
                                        class="main-card-footer bg-transparent"
                                    >
                    ...
                    <div class="text-center">
                        <button class="btn btn-secondary mt-3" id="btnPlus">
                            더보기
                        </button>
                    </div>
                </div>
            ...
            <section id="lotto-section" class="lotto-body">
                <div class="lotto-container">
                    ...
                    <div class="user-numbers">
                        <label for="number-selects"
                            >번호를 선택하세요 (1-36):</label
                        >
            ...
            <div class="container p-4">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li>
                                <a href="#!" class="text-dark">인기 명소</a>
                            </li>
                            <li>
                                <a href="#!" class="text-dark">새로운 장소</a>
                            </li>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li>
                                <a href="#!" class="text-dark">여행 후기</a>
                            </li>
