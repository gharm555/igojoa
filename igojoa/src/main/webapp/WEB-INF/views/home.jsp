    ...
    <section id="main-section">
      ...
      <div class="d-flex justify-content-center mb-4">
        <div class="btn-group" role="group">
          <button class="btn btn-outline-secondary" id="iScore"
            type="button" data-sortIscore="1">아이난이도</button>
              ...
              <div class="main-card go-to-details"
                ...
                <div class="main-card-header bg-transparent">
                  ...
                  <div class="main-badges mt-3">
                    <span class="badge"><i class="bi bi-fire"
                      id="fire"></i> ${place.highestBadge}</span> <span
                      class="badge"><i class="bi bi-fire"
                      id="fire"></i> ${place.secondHighestBadge}</span> <span
                      class="badge difficulty-badge"
                      data-iscore="${place.IScore}">아이난이도:
                      ${place.IScore}</span>
                  </div>
                </div>
                ...
                <div class="main-card-body">
                  <img src="${place.firstUrl}" alt="${place.placeName}"
                    class="img-fluid mb-2" /> <img
                    src="${place.secondUrl}" alt="${place.placeName}"
                    class="img-fluid mb-2" /> <img
                    ...
                    <div class="post-info">
                      ...
                      <span class="date"><i
                        class="bi bi-calendar3"></i> <fmt:formatDate
                          pattern="yyyy-MM-dd" value="${parsedDateTime}" /></span>
                      <span class="likes"><i
                        class="bi bi-heart-fill"></i> ${place.likeCount}</span>
                    </div>
                  </div>
