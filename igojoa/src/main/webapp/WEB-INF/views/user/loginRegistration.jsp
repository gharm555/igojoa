          ...
          <form action="${loginUrl}" id="loginForm" method="post">
            ...
            <div class="find">
              <a type="button" class="btnIdPw" data-bs-toggle="modal"
                ...
                data-bs-target="#findPasswordModal">비밀번호를
                잊으셨나요?</a>
            </div>
          </form>
        </div>
        <div class="form signupform">
          ...
          <form action="${registerUrl}" id="registerForm" method="post"
            ...
            <div id="password-confirm-check-message"
              class="invalid-feedback" style="display: none"></div>
            ...
            <div class="d-flex align-items-baseline" id="phone-input">
              ...
              <span>-</span> <input type="text" class="form-control"
                placeholder="1234" id="phone2" name="phone2"
                maxlength="4"
                oninput="validateInput('phone', this.value)" />
              <span>-</span> <input type="text" class="form-control"
                placeholder="5678" id="phone3" name="phone3"
                maxlength="4"
                oninput="validateInput('phone', this.value)" />
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" id="findUserIdModalBody">
          ...
          <input type="nickName" name="nickName"
            id="nickNameForFindUserId" class="form-control mt-2"
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body" id="findPasswordModalBody">
          ...
          <input type="email" id="emailForFindPassword"
            class="form-control mt-2" placeholder="이메일을 입력해 주세요" />
          <input type="nickName" id="nickNameForFindPassword"
            class="form-control mt-2" placeholder="닉네임을 입력해 주세요" />
          <label id="findPasswordMessage" class="invalid-feedback"
            style="display: none"></label>
        </div>
