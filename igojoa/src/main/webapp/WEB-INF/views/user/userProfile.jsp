...
<body>
	<header>
			...
			<div class="container-fluid">
				<div class="container-sideNav">
					<button class="navbar-toggler" type="button"
						onclick="toggleSideNav()" aria-controls="sideNav">
						<span class="navbar-toggler-icon"></span>
					</button>
				</div>
				<div class="container-logo">
					<a class="navbar-brand mx-auto" id="goToTop" href="#"><h2
							class="m-0">아이고좋아</h2></a>
				</div>
				<div class="container-user">
					<c:if test="${userId == null}">
						<button type="button" class="btn btn-outline-primary me-2 nav-btn"
					...
					<c:if test="${userId != null}">
						<div class="userProfile" onclick="toggleProfileDropdown()">
							...
							<div class="dropdown-menu">
								<button class="dropdown-item" id="goUserProfileBtn">
									마이페이지</button>
								<button class="dropdown-item" id="locationVerifyBtn">
									위치인증</button>
		...
		<div id="sideNav">
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link" href="#" id="goMain">메인</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="#"
					id="goPopular">추천명소</a></li>
				<li class="nav-item"><a class="nav-link" href="#" id="goGame">미니게임</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="#" id="goFAQ">자주묻는질문</a>
				</li>
			</ul>
		</div>

		<div class="banner-toggle-container">
			<button class="btn btn-outline-primary banner-toggle"
		...
		<div class="banner-container">
			<div class="banner-content">
				<div id="banner-inner" class="carousel slide"
					...
					<button class="carousel-control-prev" type="button"
						data-bs-target="#banner-inner" data-bs-slide="prev">
						<span class="carousel-control-prev-icon" aria-hidden="true"></span>
						<span class="visually-hidden">Previous</span>
					</button>
					<button class="carousel-control-next" type="button"
						data-bs-target="#banner-inner" data-bs-slide="next">
				...
				<div class="col-md-3 sidebar">
					...
					<div class="profile-summary">
						<input type="file" id="profileImageInput" style="display: none"
							accept="image/*" /> <img src="${ userInfo.userProfileUrl }"
							alt="프로필 이미지" id="userPrifileUrl"
				...
				<div class="col-md-9 content p-5">
					<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="card">
								<div class="card-body">
									...
									<p class="card-text" id="currentsPoints">
										누적 포인트:
										<fmt:formatNumber value="${userInfo.currentsPoints}"
						...
						<div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
							...
							<form>
								<div class="mb-3">
									<label for="nickName" class="form-label">사용자 닉네임</label> <input
										type="text" class="form-control" id="nickName" value="" />
								</div>
								<div class="mb-3">
								...
								<div class="mb-3">
									...
									<div class="phone-input-container"
										...
										<input type="text" class="form-control phone-input"
											...
											style="width: 60px; text-align: center;" /> <span>-</span> <input
											type="text" class="form-control phone-input" id="phone2"
											maxlength="4" style="width: 80px; text-align: center;" /> <span>-</span>
										<input type="text" class="form-control phone-input"
								...
								<div class="mb-3 d-none" id="passwordGroup1">
									<label for="newPassword" class="form-label">비밀번호</label> <input
								...
								<div class="mb-5 mt-4">
									<button id="passwordShowBtn" type="button"
										...
										onclick="showPasswordFields()">비밀번호 변경</button>
								</div>
								<div>
						...
						<div class="tab-pane fade" id="v-pills-disabled" role="tabpanel"
							...
							<div class="search-container">
								...
								</select> <select id="search-category">
								...
								<div class="dropdown">
									...
									<ul class="dropdown-menu" aria-labelledby="sortDropdown">
										<li><a class="dropdown-item" href="#"
											onclick="sortActivities('latest')">최신순</a></li>
										<li><a class="dropdown-item" href="#"
											onclick="sortActivities('oldest')">오래된순</a></li>
									</ul>
								</div>
								<nav>
									<div class="nav nav-tabs" id="nav-tab" role="tablist">
										<button class="nav-link active" id="nav-home-tab"
											...
											좋아요 게시물</button>
										<button class="nav-link" id="nav-liked-posts-tab"
											data-bs-toggle="tab" data-bs-target="#nav-liked-posts"
											type="button" role="tab" aria-controls="nav-liked-posts"
											aria-selected="false">좋아요 리뷰</button>
										<button class="nav-link" id="nav-profile-tab"
											data-bs-toggle="tab" data-bs-target="#nav-profile"
											type="button" role="tab" aria-controls="nav-profile"
											aria-selected="false">작성 리뷰</button>
										<button class="nav-link" id="nav-contact-tab"
											data-bs-toggle="tab" data-bs-target="#nav-contact"
											type="button" role="tab" aria-controls="nav-contact"
											aria-selected="false">위치인증 장소</button>
									</div>
								</nav>
							</div>
							<div class="tab-content" id="nav-tabContent">
								...
								<div class="tab-pane fade show active" id="nav-home"
									...
									<ul class="list-group" id="activityList">
										...
										<li class="list-group-item d-flex align-items-center"><img
											src="https://placehold.co/50x50" alt="프로필"
								...
								<!-----------좋아요 리뷰 목록 섹션 --------->
								<div class="tab-pane fade" id="nav-liked-posts" role="tabpanel"
									aria-labelledby="nav-liked-posts-tab" tabindex="0">
									<ul class="list-group" id="likedPostsList">
										<!-- 좋아요 리뷰 목록 추가 -->
										<li class="list-group-item d-flex align-items-center"><img
											src="https://placehold.co/50x50" alt="게시물 썸네일"
											class="rounded-circle me-3" width="50" height="50" />
											<div>
							...
							<div class="row">
								...
								<div class="col-md-5">
									<div class="point-summary mb-3">
										<span class="me-3">얻은 포인트: <span id="earnedPoints"
											class="text-success">0</span>
										</span> <span>소비 포인트: <span id="spentPoints"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="passwordForm">
						<div class="mb-3">
							<label for="password" class="form-label">비밀번호를 입력해주세요:</label> <input
