...
<!-- Google tag (gtag.js) -->
<script async
  src="https://www.googletagmanager.com/gtag/js?id=G-4D27EJ04G9"></script>
<script>
      ...
      <div class="row g-0 h-100">
        <div class="col-md-3 sidebar">
          ...
          <nav class="nav flex-column flex-md-column nav-pills"
            ...
            <button class="nav-link active flex-sm-fill"
              id="v-pills-home-tab" data-bs-toggle="pill"
              data-bs-target="#v-pills-home" type="button" role="tab">
              <i class="fas fa-user tab-icon me-2"></i>내정보
            </button>
            <button class="nav-link flex-sm-fill"
            ...
            <button class="nav-link flex-sm-fill"
              ...
              data-bs-target="#v-pills-disabled" type="button"
              role="tab">
            ...
            <div class="tab-pane fade show active" id="v-pills-home"
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text" id="userId">${ userInfo.userId }
                  </p>
                  ...
                  <p class="card-text" id="email">${ userInfo.email }
                  </p>
            ...
            <div class="tab-pane fade" id="v-pills-profile"
              ...
              <div class="containerImageChange"
                ...
                <div class="info infoInImageChangeContainer">
                  <p style="opacity: 0.8">98x98픽셀 이상, 10MB 이하의 사진이
                    권장됩니다. PNG 또는 GIF(애니메이션 GIF 제외) 파일을 사용하세요. 사진이
                    Igojoa 커뮤니티 가이드를 준수해야 합니다.</p>
                  <div class="buttons">
              ...
              <div
                ...
                <nav class="dateRangeWithNavs">
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link active d-flex"
                      id="nav-total-tab" data-bs-toggle="tab"
                      data-bs-target="#nav-total" type="button"
                      role="tab" aria-controls="nav-total"
                      aria-selected="true">
                      전체 내역
                      <p>
                    ...
                    <button class="nav-link d-flex"
                      id="nav-favoritePlace-tab" data-bs-toggle="tab"
                      data-bs-target="#nav-favoritePlace" type="button"
                      role="tab" aria-controls="nav-favoritePlace"
                      aria-selected="false">
                      좋아요한 게시물
                      <p>
                        <i class="sort-icon fa-solid fa-sort"></i>
                    ...
                    <button class="nav-link d-flex"
                      id="nav-likedReview-tab" data-bs-toggle="tab"
                      data-bs-target="#nav-likedReview" type="button"
                      role="tab" aria-controls="nav-likedReview"
                      aria-selected="false">
                      좋아요한 리뷰
                      <p>
                        <i class="sort-icon fa-solid fa-sort"></i>
                    ...
                    <button class="nav-link d-flex"
                      id="nav-writtenReview-tab" data-bs-toggle="tab"
                      data-bs-target="#nav-writtenReview" type="button"
                      role="tab" aria-controls="nav-writtenReview"
                      aria-selected="false">
                      작성한 리뷰
                      <p>
                        <i class="sort-icon fa-solid fa-sort"></i>
                    ...
                    <button class="nav-link d-flex"
                      id="nav-verifiedPlace-tab" data-bs-toggle="tab"
                      data-bs-target="#nav-verifiedPlace" type="button"
                      role="tab" aria-controls="nav-verifiedPlace"
                      aria-selected="false">
                      위치인증 장소
                      <p>
